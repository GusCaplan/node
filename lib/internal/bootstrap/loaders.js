...
(function bootstrapInternalLoaders(process, getBinding, getLinkedBinding,
  ...
  let isNative;
  {
    // Here we create a regex which will match native functions
    // with whatever engine Node.js happens to be used in.
    // This does rely on Function.prototype.toString being a native
    // method but it is quite unlikely that it will not be.
      ...
      if (config.experimentalModules && !NativeModule.isInternal(this.id)) {
        ...
        const update = (property, value) => {
          if (this.reflect !== undefined &&
              ObjectHasOwnProperty.call(this.reflect.exports, property))
        ...
        // mitigates https://crbug.com/v8/5773 where calling
        // a native method with a proxy receiver will throw.
        ...
        const proxy = new Proxy(this.exports, {
          ...
          getOwnPropertyDescriptor: (target, prop) => {
            ...
            if (descriptor && ObjectHasOwnProperty.call(descriptor, 'value'))
