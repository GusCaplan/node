...
* `options`
  * `specifier` {string} String used in module resolution and stack traces.
...
- `'linking'`: `module.link()` has been called, but not all Promises returned
  by the linker function has been resolved yet.
...
The specifier of the current module, as set in the constructor.
